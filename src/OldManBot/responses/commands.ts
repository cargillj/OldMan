...
const jokePhrase = RegExp(`${CMD_PREFIX}joke`)
export const joke = new Response({
  name: '$joke',
  trigger: jokePhrase,
  onTrigger: [
    () => 'Post Malone? More like Lost maPhone amirite? :clown:',
    () =>
      'I only know that one Post Malone joke, go ask some _other_ bot if you want jokes from an API'
  ],
  desc: "Prepare your sides because they're gonna blast off"
})
